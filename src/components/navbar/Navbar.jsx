  ...
  return (
    <div className="py-1 pt-3">
      <div className="container mx-auto flex flex-col md:flex-row justify-between  items-start md:items-center ">
        ...
        <div className={`${show ? "max-h-screen" : "mobile:max-h-0 md:max-h-screen"} md:flex overflow-hidden transition-max-height duration-500 ease-linear gap-10 w-full md:w-auto mt-4 md:mt-0`}>
          ...
          <div className="flex flex-col md:flex-row gap-5 items-center md:items-center mt-3 md:mt-0">
            {/* <TbBrightnessUp className="text-black text-center text-xl" /> */}
            <ModeToggle/>
